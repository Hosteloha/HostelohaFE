...
public class ImageWindow extends RelativeLayout {
    ...
    private int mCloseIcon = R.drawable.ic_cancel_24px;
    ...
    private void initializeParameters(AttributeSet attrs) {
        ...
        for (int i = 0; i < N; ++i) {
            ...
            if (attr == R.styleable.ImageWindow_close_color) {
                ...
                mCloseIcon = a.getResourceId(R.styleable.ImageWindow_close_icon, R.drawable.ic_cancel_24px);
    ...
    static class CustomImageView extends androidx.appcompat.widget.AppCompatImageView {
